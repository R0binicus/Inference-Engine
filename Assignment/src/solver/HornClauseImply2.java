...
public class HornClauseImply2 extends ClauseParent {
	...
	public HornClauseImply2(ClauseParent FirstSymbol, String LogicSymbol, ClauseParent SecondSymbol){ //Two classes as symbols
	...
	public HornClauseImply2(String FirstSymbol, String LogicSymbol, String SecondSymbol){  //Two Strings as symbols
		stateA = true; 
	...
	public HornClauseImply2(ClauseParent FirstSymbol, String LogicSymbol, String SecondSymbol){  //One class and one string as symbols
		stateA = true; 
		symbolAClass = FirstSymbol;
		logic = LogicSymbol;
		stateB = true; 
	...
	public HornClauseImply2(String FirstSymbol, String LogicSymbol, ClauseParent SecondSymbol){  //One string and one class as symbols
		stateA = true; 
		symbolAString = FirstSymbol;
		logic = LogicSymbol;
		stateB = true; 
	...
	public String clauseString(){
		...
		if (stateB == false)
		{
			...
			//returnString += "~" + symbolBClass.getSymbolB() + " ";
		}
		else
		{
			if (symbolAClass != null)
